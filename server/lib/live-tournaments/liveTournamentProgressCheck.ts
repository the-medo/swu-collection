    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          leaderCardId1: sql`excluded.leader_card_id_1`,
          baseCardKey1: sql`excluded.base_card_key_1`,
          leaderCardId2: sql`excluded.leader_card_id_2`,
          baseCardKey2: sql`excluded.base_card_key_2`,
