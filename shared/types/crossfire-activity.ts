...
/** Public leader/base IDs from the decks admitted to the game, viewer's seat first.
 * Null when access is no longer available; no deck links or contents are exposed. */
export type CrossfireGameArtwork = {
  leaders: (string | null)[] | null;
  /** Same seat order as leaders. Optional for older cached HTTP responses. */
  bases?: (string | null)[] | null;
};
