...
export interface RecentTournamentsDropdownMenuProps {
  className?: string;
}

const RecentTournamentsDropdownMenu: React.FC<RecentTournamentsDropdownMenuProps> = ({ className }) => {
  return (
...
export default RecentTournamentsDropdownMenu;
