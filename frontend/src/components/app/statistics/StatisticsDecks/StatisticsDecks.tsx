...
const StatisticsDecks: React.FC<StatisticsDecksProps> = ({ teamId }) => {
  ...
  if (sDeckId) {
    return (
      <StatisticsDeckDetail
        teamId={teamId}
        matches={gameResultData.matches.byDeckId.matches[sDeckId]}
      />
    );
  }
  return <StatisticsDeckLists teamId={teamId} byDeckId={gameResultData.matches.byDeckId} />;
};
