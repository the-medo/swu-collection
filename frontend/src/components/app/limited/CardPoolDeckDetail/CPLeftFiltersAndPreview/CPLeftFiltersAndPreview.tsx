  ...
  return (
    <div
      className={cn('overflow-hidden w-full md:border-r max-md:border-b flex flex-col gap-2', {
        'md:min-w-[50px] md:max-w-[50px] md:-mt-[15px] md:-ml-[1px]': !filtersExpanded,
    ...
    >
      {!filtersExpanded && (
        ...
        >
          <div
            className="text-2xl font-semibold tracking-tight cursor-pointer flex items-center gap-2 hover:underline"
