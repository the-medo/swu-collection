...
export const Route = createFileRoute('/teams/$teamId/statistics/_statisticsLayout/decks/')({
  component: TeamStatisticsDecksPage,
  head: () => ({
    meta: [
      {
        title: 'Team Decks | SWUBase',
      },
    ],
  }),
});

function TeamStatisticsDecksPage() {
  ...
  return <StatisticsDecks teamId={team.id} />;
}
