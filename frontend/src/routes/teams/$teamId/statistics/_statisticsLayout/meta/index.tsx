...
export const Route = createFileRoute('/teams/$teamId/statistics/_statisticsLayout/meta/')({
  component: TeamStatisticsMetaPage,
  head: () => ({
    meta: [
      {
        title: 'Team Meta | SWUBase',
      },
    ],
  }),
});

function TeamStatisticsMetaPage() {
